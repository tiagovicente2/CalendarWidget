...
public abstract class Hilt_WelcomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WelcomeFragment() {
    super();
  }

  Hilt_WelcomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WelcomeFragment_GeneratedInjector) this.generatedComponent()).injectWelcomeFragment(UnsafeCasts.<WelcomeFragment>unsafeCast(this));
    }
  }
